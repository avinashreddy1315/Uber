    ...
    <div>
      ...
      <div className="flex justify-between items-center">
        ...
        <div className='flex-row text-left'>
          <p>Captain Name</p>
          <h2 className='text-xl font-extrabold capitalize '>{props.ride?.captain?.fullname?.firstname + " " + props.ride?.captain?.fullname?.lastname}</h2>
        </div>
      ...
      <div className='flex items-center justify-between border-b-2 p-3' >
        <div>
          <div className=' flex-row'>
            <p>Captain is</p>
            <h2 className='text-xl font-extrabold capitalize pl-3'>{props.ride?.durationToTime} Away</h2>
          </div>
          <div>
            <p>Vehicle Plate</p>
